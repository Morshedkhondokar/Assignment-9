const Banner = () => {
  return (
    <div className="w-full mb-5 min-h-screen  bg-[linear-gradient(to_bottom,rgba(0,0,0,0.2),rgba(0,0,0,0.5)),url('https://i.pinimg.com/736x/07/ad/38/07ad386ab0e2bbc1dea1bf07ac07b132.jpg')] bg-cover  bg-center  
    flex justify-center items-center p-5 ">
      <div className="flex flex-col items-center justify-center h-full text-center -mt-10">
        ...
        <button className="animate__animated animate__fadeInUp btn bg-blue-600 border-none text-white mt-8">
          Donate Now
        </button>
      </div>
    </div>
